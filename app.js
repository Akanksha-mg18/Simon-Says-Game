...
function checkAns(idx) {
    if (userseq[idx] === gameseq[idx]) {
        ...
        // Add the "failed" class to change the background color
        document.body.classList.add("failed");

        // Remove the "failed" class after a short delay
        setTimeout(function() {
...
$(".btn").on("click", function() {
    ...
    // Remove the class after 200ms to simulate a quick click effect
    setTimeout(() => button.removeClass("clicked"), 200);
});
